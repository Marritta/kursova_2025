...
public class AuthServiceImpl implements AuthService {
    ...
    private void sendRegistrationVerificationEmail(User user) {
        String subject = "Будь ласка, підтвердіть свою реєстрацію";
        String content = "Шановна(ий) " + user.getUsername() + ",<br><br>"
                + "<p>Дякуємо, що приєдналися до нас! Ми раді вітати вас з нами.</p><br>"
                + "<p>Щоб завершити процес реєстрації, введіть код підтвердження на своєму пристрої.</p><br>"
                + "<p>Код підтвердження: <strong>" + user.getVerificationCode() + "</strong></p><br>"
                + "<p><strong>Зверніть увагу, що термін дії вищезазначеного коду підтвердження закінчиться протягом 15 хвилин.</strong></p>"
                + "<br>Дякуємо,<br>"
                + "Команда Зелений дім.";
